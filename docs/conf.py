...
release = pkg_resources.get_distribution("catalystcoop.ferc1_eia_match").version

# -- Project information -----------------------------------------------------

project = "FERC EIA Match"
copyright = (  # noqa: A001
...
# GitHub repo
issues_github_path = "catalyst-cooperative/ccai-entity-matching"
